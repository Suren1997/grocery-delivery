        ...
        {items.length > 0 && (
          <div className="p-5 border-t border-app-border space-y-3">
            ...
            <button
              ...
              className="w-full py-3 bg-app-orange text-white font-semibol rounded-xl hover:bg-app-orange-dark transition-colors flex-center gap-2 active:scale-[0.98]"
            >
              Procced to CheckOut <ArrowRightIcon className="size-4" />
            </button>
          </div>
        )}
      </div>
