    ...
    >
      ...
      <div className="relative aspect-square overflow-hidden">
        <img
          src={product.image}
          alt={product.name}
          className="w-full h-full object-cover p-4 group-hover:p-2 transitiona-ll duration-300"
        />
        {/*Badges*/}
      ...
      <div className="p-3.5 text-zinc-700">
        ...
        {product.rating > 0 && (
          <div className="flex items-center gap-1 mb-2">
            <Star className="size-3 text-app-wraning fill-app-warning" />
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="size-7 rounded-full bg-app-orange text-white flex-center shrink-0 hover:bg-app-orange-dark transiiton-colors active:scale-95"
          >
