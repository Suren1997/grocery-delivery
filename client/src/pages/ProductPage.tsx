...
const ProductPage = () => {
  const currency = import.meta.env.VITE_CURRECY_SYMBOL || "$";
  const { id } = useParams();
  ...
  return (
    <div className="min-h-screen">
      <div className="max-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/**BreadCrumb */}
            ...
            <div className="p-6 md:p-10 flex flex-col justify-center">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`flex-1 py-3 font-semibold rounded-xl transition-colors flex-center gap-2 disabled:opacity-40 disabled:cursor-not-allowed active:scale-[0.98] ${inCart ? "bg-app-cream text-app-green border border-app-green" : "bg-app-orange text-white hover:bg-app-orange-dark"}`}
                >
